...
$$\begin{bmatrix} x & y & z \end{bmatrix} \begin{bmatrix} m_{xx} & m_{xy} & m_{xz}\\ m_{xy} & m_{yy} & m_{yz}\\ m_{xz} & m_{yz} & m_{zz} \end{bmatrix} \begin{bmatrix} x \\ y \\ z \end{bmatrix} + 2 \begin{bmatrix} m_{x} & m_{y} & m_{z} \end{bmatrix} \begin{bmatrix} x \\ y \\ z \end{bmatrix} + m_{0} = 0$$

Which we can write compactly as:

$$x^TAx + 2B^Tx + m_{0} = 0$$
$$x = \begin{bmatrix} x \\ y \\ z \end{bmatrix} \quad A = \begin{bmatrix} m_{xx} & m_{xy} & m_{xz}\\ m_{xy} & m_{yy} & m_{yz}\\ m_{xz} & m_{yz} & m_{zz} \end{bmatrix} \quad B = \begin{bmatrix} m_{x} \\ m_{y} \\ m_{z} \end{bmatrix}$$
...
$$\begin{bmatrix} x & y & z & 1 \end{bmatrix} \begin{bmatrix} m_{xx} & m_{xy} & m_{xz} & m_{x}\\ m_{xy} & m_{yy} & m_{yz} & m_{y}\\ m_{xz} & m_{yz} & m_{zz} & m_{z}\\ m_{x} & m_{y} & m_{z} & m_{0} \end{bmatrix} \begin{bmatrix} x \\ y \\ z \\ 1 \end{bmatrix} = 0$$

Which we write as:

$$\hat{x}^TM\hat{x} = 0$$
$$\hat{x} = \begin{bmatrix} x \\ y \\ z \\ 1 \end{bmatrix} \quad M = \begin{bmatrix} m_{xx} & m_{xy} & m_{xz} & m_{x}\\ m_{xy} & m_{yy} & m_{yz} & m_{y}\\ m_{xz} & m_{yz} & m_{zz} & m_{z}\\ m_{x} & m_{y} & m_{z} & m_{0} \end{bmatrix}$$